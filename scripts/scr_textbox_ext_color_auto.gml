///scr_textbox_ext_color_auto("text", font, timer, txtSpeed, sfx, top, text_color, textbox_color, border_color, border_width);
...
sfx - the sound effect you wanna pass in. type 'noone' for no sfx.
...
textbox_color = argument7;
border_color = argument8;
border_width = argument9;
